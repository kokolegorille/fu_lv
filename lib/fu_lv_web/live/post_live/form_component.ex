defmodule FuLvWeb.PostLive.FormComponent do
  use FuLvWeb, :live_component
  ...
  defp save_post(socket, :edit, post_params) do
    ...
    case Cms.update_post(post, post_params, &consume_photos(socket, &1)) do
      {:ok, _post} ->
        {:noreply,
         socket
  ...
  defp save_post(socket, :new, post_params) do
    ...
    case Cms.create_post(post, post_params, &consume_photos(socket, &1)) do
      {:ok, _post} ->
        {:noreply,
         socket
